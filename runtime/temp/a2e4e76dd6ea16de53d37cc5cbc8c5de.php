<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:82:"E:\xampp\htdocs\wechat\public/../application/index\view\pacttype\workexc_type.html";i:1503648170;s:70:"E:\xampp\htdocs\wechat\public/../application/index\view\head_type.html";i:1503991122;s:71:"E:\xampp\htdocs\wechat\public/../application/index\view\pub_button.html";i:1504003892;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
    <title>独家协议-工作室</title>
...
<script>
    ...
    <div class="content-header">
        <h1 class="text-bold text-center">独家协议 - 工作室&优星库</h1>
    ...
    <div class="content-main">
        ...
        <p>（2）[艺人姓名]（身份证号：[  ]，下称“<strong>乙方艺人</strong>”）是一位具有 <strong>中国国籍</strong>的自然人（非未成年人），具有良好的艺术天赋与条件，具备从事演艺事业的潜质；</p>
        <p>（3）乙方是乙方艺人[艺人姓名]根据中国法律设立并存续的个人独资企业；有权代表乙方艺人签订本协议；</p>
        <p>（4）甲乙双方拟就乙方艺人的演艺事业中的商务事务的代理事宜进行合作。</p>
        ...
        <p>1.1.3上述商务事务相关的维权事宜：仅指就上述商务事务，追究商务事务合作方的违约责任、追究第三方的侵权责任等要求第三方承担责任和赔偿损失的事项。</p>
        <h2>1.2合作期限</h2>
        ...
        <h2>1.3合作地域：全世界范围。</h2>
        <h2>1.4合作性质</h2>
        <p class="text-bold text-underline">本协议项下的合作为独家、排他合作，即：无论是有偿还是无偿，乙方及乙方艺人不应就乙方艺人的商务事务与商务合作方达成任何合作，也不应将乙方艺人的商务事务委托除甲方以外的其他方进行代理，或与除甲方以外的其他方就本协议约定的合作范围所涉事宜开展相同或相似的合作。</p>
        <h2>1.5转授权：详见<span class="text-underline">第10.2条</span>。</h2>

        <h1>2.商务事务安排</h1>
        <h2>2.1在合作期限内，甲方有权以乙方艺人的“独家商务代理公司”或类似的名义对外开展本协议项下的全部工作，乙方及/或乙方艺人应按甲方的需求向甲方出具 <strong class="text-underline">《授权书》</strong>，其形式和内容详见 <strong class="text-underline">附件一，但甲方有权根据本协议项下工作的实际需要，要求调整《授权书》的内容，乙方及/或乙方艺人应配合签署。</strong>前述《授权书》与本协议约定不一致的，以本协议为准。</h2>
        <h2>2.2甲方代表乙方及/或乙方艺人签署商务合同前，应将拟签署的商务合同以书面形式提供给乙方审核确认；<strong>乙方收到甲方提供的拟签署的商务合同之日起[5]日内（下称“商务合同确认期”）应书面回复确认或提出书面修改意见，逾期未书面回复确认或提出书面修改意见的，视为乙方确认拟签署的商务合同。</strong>乙方提出书面修改意见，在甲方重新向乙方提供修订的商务合同后，乙方仍应按商务合同确认期进行书面确认或提出书面修改意见，此后均依此执行。</h2>
        ...
        <h2>2.9如发生本协议项下的维权事宜，乙方及其应确保乙方艺人配合甲方代表乙方及/或乙方艺人解决该等事宜，包括但不限于出具授权书和协助提供、搜集相关证据。</h2>
        <h2 class="text-bold text-underline">2.10双方确认，如商务事务合作方出现未取得从事品牌、商品或服务的生产经营活动的行政许可、产品质量缺陷或侵犯第三方合法权益（如商标侵权等）等违规经营情形，并导致乙方及/或乙方艺人名誉或形象受损、产生经济损失或被追究法律责任的，甲方将依据本协议约定进行维权，而无需就此向乙方及/或乙方艺人承担任何责任，乙方自身及其应确保乙方艺人不得就此向甲方提出承担责任或赔偿损失的要求。</h2>
        ...
        <p>3.1.3尽管有本<span class="text-underline">第3.1条</span>前述约定，双方确认，与商务事务维权事宜相关的费用由双方单独结算，即不随同每笔商务收入进行结算与支付。<strong class="text-underline">商务事务维权事宜所产生的成本（下称“维权费用”）由双方按商务收入的分配比例（即甲方[  ]%、乙方[  ]%）共同承担，其维权收入扣除维权费用后的款项由双方按前述比例共享。</strong></p>
        <h2>3.2收入分配顺序、比例</h2>
        <p>3.2.1扣除商务合同项下应缴纳的税款；</p>
        <p class="text-bold text-underline">3.2.2商务收入扣除上述第3.2.1条约定的税款后的剩余款项由双方按照甲方[  ]%、乙方[  ]%的比例进行分配。</p>
        <h2>3.3收入结算与支付</h2>
        <p>甲方在收到每笔商务收入之日起[  ]日内，按<span class="text-underline">第3.2.1条</span>约定扣除税款后，将应分配给乙方的款项支付至乙方指定的收款账户（详见<span class="text-underline">第3.4条</span>）。</p>
