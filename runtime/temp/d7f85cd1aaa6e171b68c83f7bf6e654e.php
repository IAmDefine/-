<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:81:"E:\xampp\htdocs\wechat\public/../application/index\view\pacttype\excpre_type.html";i:1504243738;s:70:"E:\xampp\htdocs\wechat\public/../application/index\view\head_type.html";i:1504079850;s:71:"E:\xampp\htdocs\wechat\public/../application/index\view\pub_button.html";i:1504003892;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
...
<script>
 ...
 <?php if(!(empty($pact) || (($pact instanceof \think\Collection || $pact instanceof \think\Paginator ) && $pact->isEmpty()))): if($pact['states']!=4): ?>
    ...
    <div class="content-header">
        <h1 class="text-bold text-center">独家协议 - 个人&优星库</h1>
        ...
        <table class="text-size-26">
            ...
            <tr class="line-height-50">
                <td class="table-title">国 籍：</td>
                <td><span class="text-underline">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></td>
            </tr>
            <tr class="line-height-50">
                <td class="table-title">证件类型：</td>
                <td><span class="text-underline">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></td>
            </tr>
            <tr class="line-height-50">
    ...
    <div class="content-main">
        ...
        <p>（2）[艺人姓名] （艺名：[  ]）是一位具有[中国]国籍的自然人（非未成年人），具有良好的艺术天赋与条件，拟从事或正在从事演艺事业；</p>
        ...
        <p>1.1.1人身权授权事宜：指将乙方的肖像、姓名、声音等与其形象、个人特征有关的元素（无论是以文字、图片、标识、视音频等形式体现，下称“个人元素”）许可、授权第三方进行使用的相关事务。</p>
        ...
        <p>1.3合作地域：全世界范围。</p>
        <h2>1.4合作性质</h2>
        <p class="text-bold text-underline">本协议项下的合作为独家、排他合作，即：无论是有偿还是无偿，乙方不应就其商务事务与商务合作方达成任何合作，也不应将其商务事务委托除甲方以外的其他方进行代理，或与除甲方以外的其他方就本协议约定的合作范围所涉事宜开展相同或相似的合作。</p>
        <h2>1.5转授权：详见<span class="text-underline">第10.2条</span>。</h2>

        <h1>2.商务事务安排</h1>
        <h2>2.1在合作期限内，甲方有权以乙方的“独家商务代理公司”或类似的名义对外开展本协议项下的全部工作，乙方应按甲方的需求向甲方出具<strong class="text-underline">《授权书》</strong>，其形式和内容详见<strong class="text-underline">附件一，但甲方有权根据本协议项下工作的实际需要，要求调整《授权书》的内容，乙方应配合签署。前述《授权书》与本协议约定不一致的，以本协议为准。</strong></h2>
        <h2>2.2甲方代表乙方签署商务合同前，应将拟签署的商务合同以书面形式提供给乙方审核确认；<strong class="text-underline">乙方收到甲方提供的拟签署的商务合同之日起[5]日内（下称“商务合同确认期”）应书面回复确认或提出书面修改意见，逾期未书面回复确认或提出书面修改意见的，视为乙方确认拟签署的商务合同。</strong>如乙方提出书面修改意见，在甲方重新向乙方提供修订的商务合同后，乙方仍应按商务合同确认期进行书面确认或提出书面修改意见，此后均依此执行。</h2>
        ...
        <h2>2.4乙方应以勤勉、敬业的精神严格遵守、配合、完成经乙方事先书面确认的商务合同项下涉及乙方的全部工作。</h2>
        <h2 class="text-bold text-underline">2.5乙方承诺，非因经甲方确认的涉及乙方自身及其近亲属的重大人身、财产事项或其他事由（乙方应向甲方提供真实、充分、合法的证明资料），乙方不得拒绝甲方洽谈、安排的商务事务，且乙方的私人活动与甲方洽谈、安排的商务事务相冲突的，应优先遵守、配合、完成甲方安排的商务事务。</h2>
        <h2 class="text-bold text-underline">2.6甲方代表乙方洽谈商务事务时，应尽力向商务合作方争取乙方的保险、服装、化妆、造型产生的费用及要求商务合作方为乙方办理在中国境内外工作的相关许可手续（如需），如商务合作方不同意承担前述费用或办理前述手续，则参加商务事务产生的保险、服装、化妆、造型的费用由乙方自行承担，前述手续的办理及相关费用的承担由甲乙双方另行协商。</h2>
        <h2 class="text-bold text-underline">2.7为履行本协议之目的，甲方有权无偿使用乙方的个人元素。</h2>
        <h2>2.8乙方最迟应在本协议签订之日起三个工作日内向甲方提交乙方的品牌、商品或服务的代言清单，并不时向甲方更新该代言清单。</h2>
        <h2>2.9如发生本协议项下的维权事宜，乙方应配合甲方代表乙方解决该等事宜，包括但不限于出具授权书和协助提供、搜集相关证据。</h2>
        <h2 class="text-bold text-underline">2.10双方确认，如商务事务合作方出现未取得从事品牌、商品或服务的生产经营活动的行政许可、产品质量缺陷或侵犯第三方合法权益（如商标侵权等）等违规经营情形，并导致乙方名誉或形象受损、产生经济损失或被追究法律责任的，甲方将依据本协议约定进行维权，而无需就此向乙方承担任何责任，乙方不得就此向甲方提出承担责任或赔偿损失的要求。</h2>
        <h2>2.11甲方有权以线上、线下等方式开展本协议项下的合作事项，包括但不限于在甲方运营的互联网平台 “优星库”（网站地址：[  ]）开展合作事项。</h2>

        <h1>3.商务收入分配</h1>
        <h2>3.1收入范围</h2>
        <p>3.1.1本协议所述“商务收入”是指因第1.1条约定的商务事务而产生的全部收入，具体金额以商务合同项下全部的收入为准，包括但不限于酬金、利润分成、奖金、不退预付款、礼品、许可费、违约金、赔偿金等货币和非货币收入（不包括乙方的保险、服装、化妆和造型的费用），无论该等收入实际发生在合作期限内或合作期限届满后。</p>
        ...
        <h2>4.2双方保证，具有洽谈、签订、履行本协议的完整的权力或已经取得充分地授权，一方洽谈、签订、履行本协议的行为不会违反任何在先义务，且不会引致另一方被以任何形式追究责任。</h2>
        <h2>4.3双方保证，不会对双方及双方基于本协议开展的合作作出任何不利的言论或行为，亦不会对外宣传双方之间存在本协议约定以外的关系。</h2>
        <h2 class="text-bold text-underline">4.4乙方保证，在本协议签订前，其未委托任何第三方代理本协议项下乙方的商务事务，也不存在对乙方将其商务事务委托甲方代理构成限制、障碍的其他事项；同时，乙方保证不存在任何限制、禁止其从事演艺事业、商务事务的情形。</h2>
        ...
        <h2 class="text-bold text-underline">6.2如乙方作出嫖娼、吸/贩毒、赌博等违反中国政治政策、法律法规、行政规章或规范性文件的言行，被任何国家政府机关采取强制措施、启动刑事追诉程序、被处以行政处罚，或因乙方的劣迹行为、负面新闻导致中国国家新闻出版广电总局等行业主管部门禁止、限制乙方从事演艺事业、商务事务或禁止、限制涉及乙方的任何活动、内容的，甲方有权单方书面通知乙方解除或终止本协议，因此给甲方造成损失的，乙方应赔偿甲方的损失。</h2>
        ...
        <h2 class="text-bold text-underline">10.3本协议经甲方盖章且乙方签字之日起生效。</h2>
