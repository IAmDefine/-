...
<body>
    ...
    <div class="weui-grids" style=" background-color:#f5f5f5;position:absolute;width:100%;">
        ...
        <a href="javascript:;" class="weui-grid" style="width:100%;text-align: center;" id="selectfiles">
            <div class="weui-msg__icon-area"><i><img src="/imgs/icon-signature.png" alt=""></i></div>
            <p class="weui-grid__label">上传签章</p>
        </a>
        <p style="color:red;float: giht;float: right;font-size: 0.7rem;margin-bottom: 0.5rem;    bottom: .9rem;"><i><img src="/imgs/icon-eye.png" alt=""></i>&nbsp;&nbsp;<u><a href="/index/sign/pact_type">查看合同</a></u></p>
    </div>
