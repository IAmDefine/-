<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:81:"E:\xampp\htdocs\wechat\public/../application/index\view\pacttype\phopre_type.html";i:1504243849;s:70:"E:\xampp\htdocs\wechat\public/../application/index\view\head_type.html";i:1504079850;s:71:"E:\xampp\htdocs\wechat\public/../application/index\view\pub_button.html";i:1504003892;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
...
<script>
 ...
 <?php if(!(empty($pact) || (($pact instanceof \think\Collection || $pact instanceof \think\Paginator ) && $pact->isEmpty()))): if($pact['states']!=4): ?>
    ...
    <div class="content-header">
        <h1 class="text-bold text-center">肖像照片独家协议 - 个人&优星库</h1>
    ...
    <div class="content-main">
        ...
        <p>1.1.1肖像照片授权事宜：指将乙方肖像照片（不包括动漫、卡通形象的图片、照片）提供给商务事务合作方以直接或间接的方式在其品牌、商品或服务中进行使用，前述事宜的开展、完成无需乙方为商务事务合作方提供任何其他具体的服务或工作。为免疑义，下述方面不属于肖像照片授权事宜：</p>
        ...
        <p>1.1.2其他人身权授权事宜：指将乙方的肖像、姓名、声音等与其形象、个人特征有关的元素（无论是以文字、图片、标识、视音频等形式体现，下称“<strong>个人元素</strong>”）许可、授权第三方进行使用的相关事务，但属于<span class="text-underline">第1.1.1条</span>约定的除外。</p>
        <p>1.1.3参加商务活动事宜：指乙方借助其形象、影响力参与的除电影、电视剧、综艺节目、网络剧、网络电影（微电影除外）、网络综艺、话剧、歌舞剧、舞台剧的演出以外的其他一切形式的商业活动，包括但不限于：</p>
        ...
        <h2>1.4合作地域：全世界范围。</h2>
        <h2>1.5合作性质</h2>
        <p>1.5.1肖像照片授权事宜：独家、排他的合作，即：无论是有偿还是无偿，乙方不应就其肖像照片授权事宜与商务合作方达成任何合作，也不应将其肖像照片授权事宜委托除甲方以外的其他方进行代理，或与除甲方以外的其他方就肖像照片授权事宜开展与本协议约定的相同或相似的合作。为免疑义，本款约定的独家、排他合作，仅限于符合<span class="text-underline">第1.1.1条</span>所述的业务合作模式，而非指人身权授权的独家、排他合作。</p>
        <p>1.5.2其他人身权授权及参加商务活动事宜：非独家合作。自合作期限开始后12个月内，如甲方为乙方成功接洽并签署2份商务合同，则本<span class="text-underline">第1.5.2条</span>约定的合作性质自动变更为独家、排他合作，即：无论是有偿还是无偿，乙方不应就其“其他人身权授权及参加商务活动事宜”与商务合作方达成任何合作，也不应将该等商务事务委托除甲方以外的其他方进行代理，或与除甲方以外的其他方就该等商务事务所涉事宜开展相同或相似的合作；甲方将就此书面通知乙方，但前述合作性质的变更不以甲方是否通知乙方为条件，该等变更自甲方根据本协议约定签署第2份商务合同之日起自动生效。</p>
        <h2>1.6转授权：详见<span class="text-underline">第10.2条</span>。</h2>

        <h1>2.商务事务安排</h1>
        <h2>2.1在合作期限内，甲方有权以乙方的“独家肖像照片代理公司”、“商务活动代理公司”或与前述二者类似的名义对外开展本协议项下的全部工作，乙方应按甲方的需求向甲方出具《授权书》，其形式和内容详见附件一和附件二，但甲方有权根据本协议项下工作的实际需要，要求调整《授权书》的内容，乙方应配合签署。前述《授权书》与本协议约定不一致的，以本协议为准。</h2>
        <h2>2.2甲方代表乙方签署商务合同前，应将拟签署的商务合同以书面形式提供给乙方审核确认；乙方收到甲方提供的拟签署的商务合同之日起[5]日内（下称“<strong>商务合同确认期</strong>”）应书面回复确认或提出书面修改意见，逾期未书面回复确认或提出书面修改意见的，视为乙方确认拟签署的商务合同。如乙方提出书面修改意见，在甲方重新向乙方提供修订的商务合同后，乙方仍应按商务合同确认期进行书面确认或提出书面修改意见，此后均依此执行。</h2>
        <h2>2.3乙方应以勤勉、敬业的精神严格遵守、配合、完成经乙方事先书面确认的商务合同项下涉及乙方的全部工作。</h2>
        <h2>2.4乙方应确保，非因经甲方确认的涉及乙方自身及其近亲属的重大人身、财产事项或其他事由（乙方应向甲方提供真实、充分、合法的证明资料），乙方不得拒绝甲方洽谈、安排的商务事务，且乙方的私人活动和第三方为乙方洽谈、安排的商务活动与甲方洽谈、安排的商务事务相冲突的，应优先遵守、配合、完成甲方安排的商务事务。</h2>
        <h2>2.5关于肖像照片授权事宜：</h2>
        <p>2.5.1本协议签订后[7]日内，双方应就肖像照片授权的行业范围进行协商，并以书面形式确定该等行业范围。乙方同意，在该等行业范围内，如乙方与第三方就品牌、商品或服务的宣传推广、代言开展独家合作的，应事先经甲方同意，未经甲方同意，乙方不得开展前述独家合作。</p>
        <p>2.5.2为开展本协议约定的肖像照片授权事宜，甲方有权使用在各渠道中取得的乙方的照片，但使用前应事先经乙方书面确认。同时，本协议签订后[7]日内，乙方应向甲方提供现有的或自费拍摄的经甲方认可的不少于[30]张的乙方的肖像照片。</p>
        <p>2.5.3尽管有<span class="text-underline">第2.2条</span>的约定，乙方同意，甲方有权决定肖像照片授权事宜的许可费标准，乙方有权提出合理建议，但最终以甲方的意见为准。</p>
        <h2>2.6除肖像照片授权事宜外，甲方代表乙方洽谈商务事务时，应尽力向商务合作方争取乙方的保险、服装、化妆、造型产生的费用及要求商务合作方为乙方办理在中国境内外工作的相关许可手续（如需），如商务合作方不同意承担前述费用或办理前述手续，则参加商务事务产生的保险、服装、化妆、造型的费用由乙方自行承担，前述手续的办理及相关费用的承担由甲乙双方另行协商。</h2>
        <h2>2.7为履行本协议之目的，甲方有权无偿使用乙方的个人元素。</h2>
        <h2>2.8乙方最迟应在本协议签订之日起三个工作日内向甲方提交乙方的品牌、商品或服务的代言清单，并不时向甲方更新该代言清单。</h2>
        <h2>2.9如发生<span class="text-underline">第1.2条</span>约定的维权事宜，乙方应配合甲方代表乙方解决该等事宜，包括但不限于出具授权书和协助提供、搜集相关证据；如因本协议约定的“其他人身权授权及参加商务活动事宜”的商务合同的履行与商务事务合作方产生纠纷的，乙方应自行解决并承担相关责任，甲方将积极配合并协助乙方维权。</h2>
        <h2>2.10双方确认，如商务事务合作方出现未取得从事品牌、商品或服务的生产经营活动的行政许可、产品质量缺陷或侵犯第三方合法权益（如商标侵权等）等违规经营情形，并导致乙方名誉或形象受损、产生经济损失或被追究法律责任的，甲方将依据本协议约定进行维权或配合维权，而无需就此向乙方承担任何责任，乙方不得就此向甲方提出承担责任或赔偿损失的要求。</h2>
        <h2>2.11甲方有权以线上、线下等方式开展本协议项下的合作事项，包括但不限于在甲方运营的互联网平台 “优星库”（网站地址：[www.youxingku.cn]）开展合作事项。</h2>
        ...
        <p>（1）就甲方代表乙方解决的维权事宜，未能扣除的维权费用由双方按商务收入的分配比例（即甲方[ ]%、乙方[ ]%）共同承担。</p>
        <p>（2）就乙方自行解决的维权事宜，维权收入不足扣除维权费用的，未能扣除的维权费用由乙方自行承担。</p>
        ...
        <h2>3.6其他：</h2>
        <p>商务收入按[人民币]结算，因此产生的汇率差损失（如有）由乙方自行承担。</p>
        <h1>4.承诺与保证</h1>
        ...
        <h2>4.4甲方保证其具有从事本协议项下业务的经营资质。</h2>
        <h1>5.保密</h1>
        ...
        <h2>6.2如乙方作出嫖娼、吸/贩毒、赌博等违反中国政治政策、法律法规、行政规章或规范性文件的言行，被任何国家政府机关采取强制措施、启动刑事追诉程序、被处以行政处罚，或因乙方的劣迹行为、负面新闻导致中国国家新闻出版广电总局等行业主管部门禁止、限制乙方从事演艺事业、商务事务或禁止、限制涉及乙方的任何活动、内容的，甲方有权单方书面通知乙方解除或终止本协议，因此给甲方造成损失的，乙方应赔偿甲方的损失。</h2>
        ...
        <h2>8.2因本协议的成立、生效、履行与解释产生的一切争议，双方应首先友好协商解决；协商不成的，任何一方均有权向本协议签订地[北京市朝阳区]有管辖的人民法院提起诉讼。<strong>双方同意，本协议项下的争议由中国法院排他性管辖。</strong></h2>
        <h1>9.通知与送达</h1>
        ...
        <h2>10.3本协议经甲乙双方签字或盖章，并于文首所载之日起生效。</h2>
