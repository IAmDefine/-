<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:82:"E:\xampp\htdocs\wechat\public/../application/index\view\pacttype\workage_type.html";i:1503648163;s:70:"E:\xampp\htdocs\wechat\public/../application/index\view\head_type.html";i:1503638385;s:71:"E:\xampp\htdocs\wechat\public/../application/index\view\pub_button.html";i:1503648091;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
    <title>代理协议-工作室</title>
...
<script>
    ...
    <div class="content-header">
        <h1 class="text-bold text-center">商务代理协议 - 工作室&优星库</h1>
    ...
    <div class="content-main">
        ...
        <p>（2）[艺人姓名]（艺名：[  ]；身份证号：[  ]，下称“乙方艺人”）是一位具有中国国籍的自然人（非未成年人），具有良好的艺术天赋与条件，具备从事演艺事业的潜质；</p>
        ...
        <p>1.1.1人身权授权事宜：指将乙方艺人的肖像、姓名、声音等与其形象、个人特征有关的元素（无论是以文字、图片、标识、视音频等形式体现，下称“<strong>个人元素</strong>”）许可、授权第三方进行使用的相关事务。</p>
        <p>1.1.2参加商务活动事宜：指乙方艺人借助其形象、影响力参与的除电影、电视剧、综艺节目、网络剧、网络电影（微电影除外）、网络综艺、话剧、歌舞剧、舞台剧的演出以外的其他一切形式的商业活动，包括但不限于：</p>
        ...
        <h2>1.2合作期限</h2>
        <p>1.2.1合作期限为[36]个月，自[  ]年[  ]月[  ]日起至[  ]年[  ]月[  ]日止。合作期限届满后，同等条件下，甲方有优先续约权。</p>
        <p>1.2.2跨期商务合同</p>
        <p>基于本协议约定，甲方在合作期限内代表乙方及/或乙方艺人与第三方签署的涉及乙方艺人的商务合同，若在合作期限届满之日或本协议终止之日尚未履行完毕的，乙方应确保乙方艺人继续履行该等商务合同或完成该等商务合同项下涉及乙方艺人的全部工作，并按照本协议约定分配商务收入（见第3条）。</p>
        <h2>1.3合作地域：全世界范围。</h2>
        <h2>1.4合作性质</h2>
        <p class="text-bold text-underline">1.4.1本协议项下的合作为非独家代理。</p>
        <p class="text-bold text-underline">1.4.2自合作期限开始后12个月内，如甲方为乙方成功接洽并签署2份商务合同，则本协议第1.4条约定的合作性质自动变更为独家、排他合作，即：无论是有偿还是无偿，乙方及乙方艺人不应就其商务事务与商务合作方达成任何合作，也不应将乙方艺人的商务事务委托除甲方以外的其他方进行代理，或与除甲方以外的其他方就本协议约定的合作范围所涉事宜开展相同或相似的合作；甲方将就此书面通知乙方，但前述合作性质的变更不以甲方是否通知乙方为条件，该等变更自甲方根据本协议约定签署第2份商务合同之日起自动生效。</p>
        <p>1.5转授权：详见<span class="text-underline">第10.2条</span>。</p>

        <h1>2.商务事务安排</h1>
        <h2>2.1在合作期限内，甲方有权以乙方艺人的“商务代理公司”或类似的名义对外开展本协议项下的全部工作，乙方及/或乙方艺人应按甲方的需求向甲方出具<strong class="text-underline">《授权书》</strong>，其形式和内容详见<strong class="text-underline">附件一，但甲方有权根据本协议项下工作的实际需要，要求调整《授权书》的内容，乙方及/或乙方艺人应配合签署。</strong>前述《授权书》与本协议约定不一致的，以本协议为准。</h2>
        <h2>2.2甲方代表乙方及/或乙方艺人签署商务合同前，应将拟签署的商务合同以书面形式提供给乙方审核确认；<strong class="text-underline">乙方收到甲方提供的拟签署的商务合同之日起[5]日内（下称“商务合同确认期”）应书面回复确认或提出书面修改意见，逾期未书面回复确认或提出书面修改意见的，视为乙方确认拟签署的商务合同。</strong>如乙方提出书面修改意见，在甲方重新向乙方提供修订的商务合同后，乙方仍应按商务合同确认期进行书面确认或提出书面修改意见，此后均依此执行。</h2>
        <h2 class="text-bold text-underline">2.3尽管有第2.1条的约定，乙方同意，甲方有权决定商务合同的合作价款标准，乙方有权提出合理建议，但最终以甲方的意见为准，包括但不限于乙方在优星库平台发布、修改的服务价格须经优星库平台审核通过方可发布、修改。</h2>
        <h2>2.4乙方应确保乙方艺人以勤勉、敬业的精神严格遵守、配合、完成经乙方事先书面确认的商务合同项下涉及乙方艺人的全部工作。</h2>
        <h2 class="text-bold text-underline">2.5乙方应确保，非因经甲方确认的涉及乙方艺人自身及其近亲属的重大人身、财产事项或其他事由（乙方应向甲方提供真实、充分、合法的证明资料），乙方及/或乙方艺人不得拒绝甲方洽谈、安排的商务事务，且乙方艺人的私人活动与甲方洽谈、安排的商务事务相冲突的，应优先遵守、配合、完成甲方安排的商务事务。</h2>
        <h2 class="text-bold text-underline">2.6甲方代表乙方及/或乙方艺人洽谈商务事务时，应尽力向商务合作方争取乙方艺人的保险、服装、化妆、造型产生的费用及要求商务合作方为乙方艺人办理在中国境内外工作的相关许可手续（如需），如商务合作方不同意承担前述费用或办理前述手续，则参加商务事务产生的保险、服装、化妆、造型的费用由乙方及/或乙方艺人自行承担，前述手续的办理及相关费用由甲乙双方另行协商。</h2>
        <h2 class="text-bold text-underline">2.7为履行本协议之目的，甲方有权无偿使用乙方的名称、标识、商标、基本资料和乙方艺人的个人元素。</h2>
        <h2>2.8乙方最迟应在本协议签订之日起三个工作日内向甲方提交乙方艺人的品牌、商品或服务的代言清单，并不时向甲方更新该代言清单。</h2>
        <h2>2.9双方同意，因商务合同的履行与商务事务合作方产生纠纷的，乙方及/或乙方艺人应自行解决并承担相关责任，甲方将积极配合并协助乙方及/或乙方艺人维权。</h2>
        <h2 class="text-bold text-underline">2.10双方确认，如商务事务合作方出现未取得从事品牌、商品或服务的生产经营活动的行政许可、产品质量缺陷或侵犯第三方合法权益（如商标侵权等）等违规经营情形，并导致乙方及/或乙方艺人名誉或形象受损、产生经济损失或被追究法律责任的，甲方将依据本协议约定配合维权，但无需就此向乙方及/或乙方艺人承担任何责任，乙方自身及其应确保乙方艺人不得就此向甲方提出承担责任或赔偿损失的要求。</h2>
        <h2>2.11甲方有权以线上、线下等方式开展本协议项下的合作事项，包括但不限于在甲方运营的互联网平台 “优星库”（网站地址：[  ]）开展合作事项。</h2>

        <h1>3.商务收入分配</h1>
        <h2>3.1收入范围</h2>
        <p>3.1.1本协议所述“<strong>商务收入</strong>”是指因第1.1条约定的商务事务而产生的全部收入，具体金额以商务合同项下全部的收入为准，包括但不限于酬金、利润分成、奖金、不退预付款、礼品、许可费、违约金、赔偿金等货币和非货币收入（不包括乙方艺人的保险、服装、化妆和造型的费用），无论该等收入实际发生在合作期限内或合作期限届满后。</p>
        <p>3.1.2为免疑义，应进行分配、结算和支付的商务收入不包括：可退的预付款、保证金、定金，或者其他尚未实际收到的款项。</p>
        <p>3.1.3尽管有本<span class="text-underline">第3.1条</span>前述约定，双方确认，与商务事务维权事宜相关的费用由双方单独结算，即不随同每笔商务收入进行结算与支付，乙方及/或乙方艺人自收到维权收入之日起[5]日内应向甲方提供维权收入报表并附相关证明文件，经甲方书面确认后乙方及/或乙方艺人应按该报表向甲方支付甲方应分配的维权收入。<strong class="text-underline">商务事务维权事宜所产生的成本（下称“维权费用”）在维权收入中扣除，维权收入不足扣除维权费用的，未能扣除的维权费用由乙方及/或乙方艺人自行承担，维权收入扣除维权费用后的款项由双方按甲方[  ]%、乙方及/或乙方艺人[  ]%的比例共享。</strong></p>
        <h2>3.2收入分配顺序、比例</h2>
        <p>3.2.1扣除商务合同项下应缴纳的税款；</p>
        <p class="text-bold text-underline">3.2.2商务收入扣除上述第3.2.1条约定的税款后的剩余款项由双方按照甲方[  ]%、乙方[  ]%的比例进行分配。</p>
        <p class="text-underline text-bold">3.2.3本协议合作性质自动变更为独家、排他合作的，自变更之日起产生的商务收入（以商务合同的签署时间为准，不包括在变更日以前已签署的商务合同所产生的商务收入）扣除上述第3.2.1条约定的税款后的剩余款项由双方按照甲方[  ]%、乙方[  ]%的比例进行分配，即前述变更合作性质后的商务收入的分配不再适用上述第3.2.2条的约定。</p>
        <h2>3.3收入结算与支付</h2>
        ...
        <p>银行账户：[  ]。</p>
        <h2>3.5税费与发票</h2>
        <p>双方应按法律规定各自缴纳各项税、费，乙方收到甲方支付的每期商务收入分配款项之日起[5]日内，应向甲方开具合法等额的增值税专用发票，甲方用以开具发票的信息如下：</p>
        ...
        <h2 class="text-underline text-bold">3.6其他：商务收入按[人民币]结算，因此产生的汇率差损失（如有）由乙方自行承担。</h2>
        ...
        <h2 class="text-bold text-underline">4.4乙方保证其有权就乙方艺人的商务事务代理事宜签订本协议，并保证促使乙方艺人向甲方出具一份《确认函》（其内容和形式详见附件二）。</h2>
        ...
        <h2 class="text-bold text-underline">6.2如乙方艺人作出嫖娼、吸/贩毒、赌博等违反中国政治政策、法律法规、行政规章或规范性文件的言行，被任何国家政府机关采取强制措施、启动刑事追诉程序、被处以行政处罚，或因乙方艺人的劣迹行为、负面新闻导致中国国家新闻出版广电总局等行业主管部门禁止、限制乙方艺人从事演艺事业、商务事务或禁止、限制涉及乙方艺人的任何活动、内容的，甲方有权单方书面通知乙方解除或终止本协议，因此给甲方造成损失的，乙方应赔偿甲方的损失。</h2>
        <h2>6.3本协议所述之“损失”均包括：直接损失、间接损失，以及为主张权利而支出的仲裁/诉讼费、律师费、交通费、通讯费等合理费用。</h2>

        <h1>7.不可抗力</h1>
        <h2>7.1本协议所称的“<strong>不可抗力</strong>”是指一切不能预见、不能避免并不能克服的客观情况，包括但不限于洪水、地震、飓风、火灾等自然灾害，战争、动乱、政府行为等重大社会事件，以及法律规定或其适用的变化。</h2>
        ...
        <h1>8.法律适用与争议解决</h1>
        <h2 class="text-bold text-underline">8.1本协议的订立、解释、履行和争议的解决均适用中国的法律；为免疑义，前述适用的法律中不包括香港、澳门、台湾的法律。</h2>
        <h2 class="text-bold text-underline">8.2因本协议的成立、生效、履行与解释产生的一切争议，双方应首先友好协商解决；协商不成的，任何一方均有权向本协议签订地北京市朝阳区有管辖的人民法院提起诉讼。双方同意，本协议项下的争议由中国法院排他性管辖。</h2>
        ...
        <h2 class="text-bold text-underline">10.2未经一方事先书面同意，另一方不得将其在本协议项下的部分或全部权利义务转让给任何第三方；尽管有前述约定，甲方有权将其在本协议项下的部分或全部权利义务转让给其关联方，或将本协议项下的工作以转代理、分包等形式与第三方进行合作，但应书面通知乙方。</h2>
        <h2 class="text-bold text-underline">10.3本协议经甲乙双方盖章之日起生效。</h2>
