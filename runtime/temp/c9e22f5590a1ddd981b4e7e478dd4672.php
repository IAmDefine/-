<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:81:"E:\xampp\htdocs\wechat\public/../application/index\view\pacttype\firexc_type.html";i:1503648145;s:70:"E:\xampp\htdocs\wechat\public/../application/index\view\head_type.html";i:1504079850;s:71:"E:\xampp\htdocs\wechat\public/../application/index\view\pub_button.html";i:1504003892;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
    <title>独家协议-经纪公司</title>
...
<script>
    ...
    <div class="content-header">
        <h1 class="text-bold text-center">独家协议 - 经纪公司&优星库</h1>
        ...
        <table class="text-size-26">
            ...
            <tr class="line-height-50">
                <td class="table-title">联 系 地 址：</td>
                <td>北京市亦庄经济技术开发区经海路7号贞观国际1号楼2层</td>
            </tr>
            <tr class="line-height-50">
                <td class="table-title">联 系 人：</td>
                <td>牛群</td>
            </tr>
            <tr class="line-height-50">
                <td class="table-title">联 系 电 话：</td>
                <td>010-85952988</td>
            </tr>
            <tr class="line-height-50">
                <td class="table-title">电 子 邮 箱：</td>
    ...
    <div class="content-main">
        ...
        <p>（2）乙方是一家依据[中国]法律设立并存续的有限公司，专业从事演艺事业经纪业务，<strong class="text-underline">为附件一所列艺人（非未成年人，下称“乙方艺人”）的独家经纪公司</strong>；</p>
        ...
        <h1>2.商务事务安排</h1>
        <h2>2.1在合作期限内，甲方有权以乙方艺人的“独家商务代理公司”或类似的名义对外开展本协议项下的全部工作，乙方及/或乙方艺人应按甲方的需求向甲方出具<strong>《授权书》</strong>，其形式和内容详见 <strong>附件二，但甲方有权根据本协议项下工作的实际需要，要求调整《授权书》的内容，乙方及/或乙方艺人应配合签署。</strong>前述《授权书》与本协议约定不一致的，以本协议为准。</h2>
        <h2>2.2甲方代表乙方及/或乙方艺人签署商务合同前，应将拟签署的商务合同以书面形式提供给乙方审核确认；<strong>乙方收到甲方提供的拟签署的商务合同之日起[5]日内（下称“商务合同确认期”）应书面回复确认或提出书面修改意见，逾期未书面回复确认或提出书面修改意见的，视为乙方确认拟签署的商务合同。</strong>如乙方提出书面修改意见，在甲方重新向乙方提供修订的商务合同后，乙方仍应按商务合同确认期进行书面确认或提出书面修改意见，此后均依此执行。</h2>
        ...
        <h2>2.8乙方最迟应在本协议签订之前向甲方提供其为乙方艺人的独家经纪公司的合同等法律文件的复印件。</h2>
        <h2>2.9乙方最迟应在本协议签订之日起三个工作日内向甲方提交乙方艺人的品牌、商品或服务的代言清单，并不时向甲方更新该代言清单。</h2>
        <h2>2.10如发生本协议项下的维权事宜，乙方及其应确保乙方艺人配合甲方代表乙方及/或乙方艺人解决该等事宜，包括但不限于出具授权书和协助提供、搜集相关证据。</h2>
        <h2 class="text-bold text-underline">2.11双方确认，如商务事务合作方出现未取得从事品牌、商品或服务的生产经营活动的行政许可、产品质量缺陷或侵犯第三方合法权益（如商标侵权等）等违规经营情形，并导致乙方及/或乙方艺人名誉或形象受损、产生经济损失或被追究法律责任的，甲方将依据本协议约定进行维权，而无需就此向乙方及/或乙方艺人承担任何责任，乙方自身及其应确保乙方艺人不得就此向甲方提出承担责任或赔偿损失的要求。</h2>
        ...
        <p>3.1.3尽管有本<span class="text-underline">第3.1条</span>前述约定，双方确认，与商务事务维权事宜相关的费用由双方单独结算，即不随同每期商务收入进行结算与支付。<strong class="text-underline">商务事务维权事宜所产生的成本（下称“维权费用”）由双方按商务收入的分配比例（即甲方[  ]%、乙方[  ]%）共同承担，其维权收入扣除维权费用后的款项由双方按前述比例共享。</strong></p>
        <h2>3.2收入分配顺序、比例</h2>
    ...
    <div class="content-footer">
        ...
        <div>
            <h2 class="line-height-50"><strong>乙方</strong>（签字）：[艺人经纪公司]</h2>
            <h2 class="line-height-50">法定代表人/授权代表（签字）：</h2>
        </div>
    </div>
</div>
