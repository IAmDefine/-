...
<script>
    ...
    <div class="content-header">
        <h1 class="text-bold text-center">肖像照片独家协议 - 工作室&优星库</h1>
    ...
    <div class="content-main">
        ...
        <p>（2）[艺人姓名]（身份证号：[ ]，下称“<strong>乙方艺人</strong>”）是一位具有中国国籍的自然人（非未成年人），具有良好的艺术天赋与条件，具备从事演艺事业的潜质；</p>
        ...
        <h2>1.6转授权：详见<span class="text-underline">第10.2条</span>。</h2>
            <h1>2.商务事务安排</h1>
            <h2>2.1在合作期限内，甲方有权以乙方艺人的“独家肖像照片代理公司”、“商务活动代理公司”或与前述二者类似的名义对外开展本协议项下的全部工作，乙方及/或乙方艺人应按甲方的需求向甲方出具《授权书》，其形式和内容详见附件一和附件二，但甲方有权根据本协议项下工作的实际需要，要求调整《授权书》的内容，乙方及/或乙方艺人应配合签署。前述《授权书》与本协议约定不一致的，以本协议为准。</h2>
        ...
        <p>2.5.3尽管有<span class="text-underline">第2.2条</span>的约定，乙方同意，并应确保乙方艺人同意，甲方有权决定肖像照片授权事宜的许可费标准，乙方及/或乙方艺人有权提出合理建议，但最终以甲方的意见为准。</p>
            <h2>2.6除肖像照片授权事宜外，甲方代表乙方及/或乙方艺人洽谈商务事务时，应尽力向商务合作方争取乙方艺人的保险、服装、化妆、造型产生的费用及要求商务合作方为乙方艺人办理在中国境内外工作的相关许可手续（如需），如商务合作方不同意承担前述费用或办理前述手续，则参加商务事务产生的保险、服装、化妆、造型的费用由乙方及/或乙方艺人自行承担，前述手续的办理及相关费用由甲乙双方另行协商。</h2>
            <h2>2.7为履行本协议之目的，甲方有权无偿使用乙方的名称、标识、商标、基本资料和乙方艺人的个人元素。</h2>
            <h2>2.8乙方最迟应在本协议签订之日起三个工作日内向甲方提交乙方艺人的品牌、商品或服务的代言清单，并不时向甲方更新该代言清单。</h2>
        <h2>2.9如发生<span class="text-underline">第1.2条</span>约定的维权事宜，乙方及其应确保乙方艺人配合甲方代表乙方及/或乙方艺人解决该等事宜，包括但不限于出具授权书和协助提供、搜集相关证据；如因本协议约定的“其他人身权授权及参加商务活动事宜”的商务合同的履行与商务事务合作方产生纠纷的，乙方及/或乙方艺人应自行解决并承担相关责任，甲方将积极配合并协助乙方维权。</h2>
            <h2>2.10双方确认，如商务事务合作方出现未取得从事品牌、商品或服务的生产经营活动的行政许可、产品质量缺陷或侵犯第三方合法权益（如商标侵权等）等违规经营情形，并导致乙方及/或乙方艺人名誉或形象受损、产生经济损失或被追究法律责任的，甲方将依据本协议约定进行维权或配合维权，而无需就此向乙方及/或乙方艺人承担任何责任，乙方自身及其应确保乙方艺人不得就此向甲方提出承担责任或赔偿损失的要求。</h2>
        ...
        <p>3.2.33.2.3本协议约定的“其他人身权授权及参加商务活动事宜”（见<span class="text-underline">第1.5.2条</span>）的合作性质自动变更为独家、排他合作的，自变更之日起产生的相关商务收入（以商务合同的签署时间为准，不包括在变更日以前已签署的商务合同所产生的商务收入）扣除上述<span class="text-underline">第3.2.1条</span>约定的税款后的剩余款项由双方按照甲方[ ]%、乙方[ ]%的比例进行分配，即前述变更合作性质后的商务收入的分配不再适用上述<span class="text-underline">第3.2.2条</span>的约定。</p>
            <h2>3.3收入结算与支付</h2>
        <p>甲方在收到每笔商务收入之日起[10]日内，按<span class="text-underline">第3.2.1条</span>约定扣除税款后，将应分配给乙方的款项支付至乙方指定的收款账户（详见<span class="text-underline">第3.4条</span>）。</p>
            ...
            <p>银行账户：[ ]。</p>
            <h2>3.5税费与发票</h2>
            <p>双方应按法律规定各自缴纳各项税、费。乙方收到甲方支付的每期商务收入分配款项之日起[5]日内，应向甲方开具合法等额的增值税专用发票，甲方用以开具发票的信息如下： 户名：前锋锐吉（北京）传媒有限公司； 账号：110921860610901； 开户行：招商银行股份有限公司北京亦庄支行； 开户地址：北京市北京经济技术开发区经海路7号院1号楼二层205室； 开户电话：010-85952988； 纳税人识别号：91110101MA0041L992。
            </p>
            <h2>3.6其他：</h2>
            ...
            <h2>4.4乙方保证其有权就乙方艺人的商务事务代理事宜签订本协议，并保证促使乙方艺人向甲方出具一份《确认函》（其内容和形式详见附件三）。</h2>
