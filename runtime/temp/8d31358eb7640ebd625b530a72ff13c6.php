<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"E:\xampp\htdocs\wechat\public/../application/index\view\sign\sign_fir.html";i:1504152044;}*/ ?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="weui-cells">
            <div class="weui-cells weui-cells_form ">
                ...
                <div class="weui-cell ">
                    ...
                    <div class="weui-cell__bd ">
                        <input class="weui-input " style="text-align: -webkit-right; " type="number " name="worktel" placeholder="请输入联系电话" value="<?php echo \think\Session::get('wx_userinfo')['mobile']; ?>"/>
                    </div>
                </div>
                <div class="weui-cell ">
            ...
            <div class="weui-cell weui-cell_select weui-cell_select-after">
                ...
                <div class="weui-cell__bd" dir="rtl">
                    <select class=" weui-select " name="coopnum">
                            <option style="color: #F5F5F5" disabled >请选择合作期限</option>
