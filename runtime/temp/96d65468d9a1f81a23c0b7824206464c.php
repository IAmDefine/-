        ...
        <div class="weui-cells">
                <a class="weui-cell weui-cell_access type" href="javascript:;">
                    <div class="weui-cell__bd">
                     <?php if($info['credtype']==1): ?>
                      <p id="types">证件类型：普通证件</p>
                     <?php else: ?>
                      <p id="types">证件类型：多证合一</p>
                     <?php endif; ?>
                        
                        <input type="hidden" name="credtype" id="credtype" value="<?php echo $info['credtype']; ?>">
                    </div>
        ...
        <div class="content " style="border-bottom:0.8rem solid #F5F5F5; ">
            <div class="weui-cells weui-cells_form ">
                <div class="weui-cell ">
                    ...
                    <div class="weui-cell__bd ">
                        <input class="weui-input " style="text-align: -webkit-right; " name="bizname" type="text " value="<?php echo $info['bizname']; ?>" placeholder="请输入公司名称" />
                    </div>
                </div>
                <div class="weui-cell ">
                    <div class="weui-cell__hd "><label class="weui-label ">企业注册号</label></div>
                    <div class="weui-cell__bd ">
                        <input class="weui-input " style="text-align: -webkit-right; " name="compno" type="text " value="<?php echo (isset($info['compno']) && ($info['compno'] !== '')?$info['compno']:''); ?>" placeholder="请输入企业注册号 " />
                    </div>
                </div>
            </div>
        </div>
        <div class="content " style="border-bottom:0.8rem solid #F5F5F5;">
            <div class="weui-cells weui-cells_form ">
                <div class="weui-cell ">
                    ...
                    <div class="weui-cell__bd ">
                        <input class="weui-input " style="text-align: -webkit-right; " name="names" value="<?php echo (isset($info['names']) && ($info['names'] !== '')?$info['names']:''); ?>" type="text " placeholder="请输入艺名 " />
                    </div>
                </div>
                <div class="weui-cell ">
                    <div class="weui-cell__hd "><label class="weui-label ">姓名</label></div>
                    <div class="weui-cell__bd ">
                        <input class="weui-input " style="text-align: -webkit-right; " name="oldname" type="text " value="<?php echo (isset($info['oldname']) && ($info['oldname'] !== '')?$info['oldname']:''); ?>" placeholder="请输入姓名 " />
                    </div>
                </div>
                <div class="weui-cell ">
                    <div class="weui-cell__hd "><label class="weui-label ">身份证号码</label></div>
                    <div class="weui-cell__bd ">
                        <input class="weui-input " style="text-align: -webkit-right; " value="<?php echo (isset($info['idno']) && ($info['idno'] !== '')?$info['idno']:''); ?>" name="idno" type="number " pattern="[0-9]* " placeholder="请输入身份证号码 " />
                    </div>
                </div>
                <div class="weui-cell ">
                    <div class="weui-cell__hd "><label class="weui-label ">邮箱</label></div>
                    <div class="weui-cell__bd ">
                        <input class="weui-input " style="text-align: -webkit-right; " name="email" value="<?php echo (isset($info['email']) && ($info['email'] !== '')?$info['email']:''); ?>" type="text " pattern="[0-9]* " placeholder="请输入邮箱 " />
                    </div>
                </div>
            </div>
        </div>
