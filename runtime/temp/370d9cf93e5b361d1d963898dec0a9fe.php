<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:81:"E:\xampp\htdocs\wechat\public/../application/index\view\pacttype\firage_type.html";i:1504243374;s:70:"E:\xampp\htdocs\wechat\public/../application/index\view\head_type.html";i:1504079850;s:71:"E:\xampp\htdocs\wechat\public/../application/index\view\pub_button.html";i:1504003892;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
    <title>代理协议-经纪公司</title>
...
<script>
 ...
 <?php if(!(empty($pact) || (($pact instanceof \think\Collection || $pact instanceof \think\Paginator ) && $pact->isEmpty()))): if($pact['states']!=4): ?>
    ...
    <div class="content-header">
        <h1 class="text-bold text-center">商务代理协议 - 经纪公司&优星库</h1>
    ...
    <div class="content-main">
        ...
        <p>（2）乙方是一家依据[中国]法律设立并存续的有限公司，专业从事演艺事业经纪业务，为附件一所列艺人（非未成年人，下称“乙方艺人”）的独家经纪公司；</p>
        ...
        <h2>1.5转授权：详见<span class="text-underline">第10.2条</span>。</h2>

        <h1>2.商务事务安排</h1>
        <h2>2.1在合作期限内，甲方有权以乙方艺人的“商务代理公司”或类似的名义对外开展本协议项下的全部工作，乙方及/或乙方艺人应按甲方的需求向甲方出具<strong class="text-underline">《授权书》</strong>，其形式和内容详见<strong class="text-underline">附件二，但甲方有权根据本协议项下工作的实际需要，要求调整《授权书》的内容，乙方及/或乙方艺人应配合签署。</strong>前述《授权书》与本协议约定不一致的，以本协议为准。</h2>
        ...
        <h2 class="text-bold text-underline">2.6甲方代表乙方及/或乙方艺人洽谈商务事务时，应尽力向商务合作方争取乙方艺人的保险、服装、化妆、造型产生的费用及要求商务合作方为乙方艺人办理在中国境内外工作的相关许可手续（如需），如商务合作方不同意承担前述费用或办理前述手续，则该等费用及手续由乙方及/或乙方艺人自行承担和办理。</h2>
        ...
        <h2>2.10双方同意，因商务合同的履行与商务事务合作方产生纠纷的，乙方及/或乙方艺人应自行解决并承担相关责任，甲方将积极配合并协助乙方维权。</h2>
        <h2 class="text-bold text-underline">2.11双方确认，如商务事务合作方出现未取得从事品牌、商品或服务的生产经营活动的行政许可、产品质量缺陷或侵犯第三方合法权益（如商标侵权等）等违规经营情形，并导致乙方及/或乙方艺人名誉或形象受损、产生经济损失或被追究法律责任的，甲方将依据本协议约定配合维权，但无需就此向乙方及/或乙方艺人承担任何责任，乙方自身及其应确保乙方艺人不得就此向甲方提出承担责任或赔偿损失的要求。</h2>
        <h2>2.12甲方有权以线上、线下等方式开展本协议项下的合作事项，包括但不限于在甲方运营的互联网平台 “优星库”（网站地址：[  ]）开展合作事项。</h2>
        ...
        <p>3.1.3尽管有本<span class="text-underline">第3.1条</span>前述约定，双方确认，与商务事务维权事宜相关的费用由双方单独结算，即不随同每期商务收入进行结算与支付，乙方及/或乙方艺人自收到维权收入之日起[5]日内应向甲方提供维权收入报表并附相关证明文件，经甲方书面确认后乙方及/或乙方艺人应按该报表向甲方支付甲方应分配的维权收入。商务事务维权事宜所产生的成本（下称“维权费用”）在维权收入中扣除，维权收入不足扣除维权费用的，未能扣除的维权费用由乙方及/或乙方艺人自行承担，维权收入扣除维权费用后的款项由双方按甲方[  ]%、乙方及/或乙方艺人[  ]%的比例共享。</p>
        <h2>3.2收入分配顺序、比例</h2>
        ...
        <h2 class="text-bold text-underline">4.4乙方保证其有权就乙方艺人的商务事务代理事宜签订本协议，并保证促使乙方艺人向甲方出具一份《确认函》（其内容和形式详见附件三）。</h2>
        ...
        <h2>5.2尽管有前述约定，双方有权因行使本协议项下的权利或自身上市、新三板挂牌、重组、公司股权融资之需要向必要的第三方（包括但不限于必要的员工、财务或法律顾问等）披露本协议全部或部分内容，不视为违约，但应确保该等接受保密信息的第三方履行不低于本<span class="text-underline">第5条</span>约定标准的保密义务。</h2>
        <h2>5.3本第5条的约定不因本协议无效、终止而失去效力，双方应始终履行保密义务直至该等保密信息非因任何一方违反保密义务而公开为止。</h2>
        ...
        <h1>8.法律适用与争议解决</h1>
        <h2 class="text-bold text-underline">8.1本协议的订立、解释、履行和争议的解决均适用中国的法律；为免疑义，前述适用的法律不包括香港、澳门、台湾的法律。</h2>
        ...
        <h2 class="text-bold text-underline">10.3本协议经甲方盖章且乙方签字或盖章之日起生效。</h2>
